const handler = async (m, {conn, participants, groupMetadata}) => {
  ...
  const {antiToxic, antiTraba, antidelete, antiviewonce, isBanned, welcome, detect, detect2, sWelcome, sBye, sPromote, sDemote, antiLink, antiLink2, modohorny, autosticker, modeadmin, audios, delete: del} = global.db.data.chats[m.chat];
