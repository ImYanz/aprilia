...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  if (!text) throw `*Example:*\n *${usedPrefix + command} Algoritma adalah*\n *${usedPrefix + command} Cara Bernafas*`;
  try {
conn.sendMessage(m.chat, { react: { text: "🕘",key: m.key,}})
      ...
      try {
        ...
        const hasill22_result = await translate(`${hasill22.result}`, {to: 'id', autoCorrect: true});
...
handler.command = /^(openai|chatgpt|ai|robot|openai2|chatgpt2|ai2|robot2|Mystic|MysticBot)$/i;
